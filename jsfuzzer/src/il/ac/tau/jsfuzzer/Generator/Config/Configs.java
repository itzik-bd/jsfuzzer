package il.ac.tau.jsfuzzer.Generator.Config;
...
public class Configs
{
	...
	{
		// load properties, use default if not supplied
		Properties p;
		if (configFile != null)
			p = FilesIO.loadPropertiesFile(configFile);
		else
			p = FilesIO.loadPropertiesFile(FilesIO.getResource(DEFAULT_CONFIG_FILE));
