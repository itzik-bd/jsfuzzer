...
import il.ac.tau.jsfuzzer.Generator.Params.*;
import il.ac.tau.jsfuzzer.Generator.SymTable.*;
...
import il.ac.tau.jsfuzzer.Main.JsFuzzerConfigs;
import il.ac.tau.jsfuzzer.Utils.OutLog;
import il.ac.tau.jsfuzzer.Utils.StdRandom;
import il.ac.tau.jsfuzzer.Utils.StringCounter;
...
public class Generator
{
	...
	// static fields
	private final static il.ac.tau.jsfuzzer.JST.Helper.Factory _factoryJST = new il.ac.tau.jsfuzzer.JST.Helper.Factory();
	private final static il.ac.tau.jsfuzzer.JST.Helper.JSTProperties _jstProp = new il.ac.tau.jsfuzzer.JST.Helper.JSTProperties();
